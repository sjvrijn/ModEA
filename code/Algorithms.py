...
def baseAlgorithm(population, fitnessFunction, budget, functions, parameters, target=None, parallel=False, debug=False):
    """
        ...
        :param target:          Target value to reach. When given a target, it is recorded after how many evaluations
                                this target was reached. Optimization does *NOT* halt when the target is reached.
