...
:returns:               The statistics generated by running the algorithm
    ...
    def __call__(self, population, fitnessFunction, budget, functions, parameters, parallel=False, debug=False):
        # Parameter tracking
        sigma_over_time = []
        fitness_over_time = []
        generation_size = []
...
:returns:               The statistics generated by running the algorithm
    ...
    return baseAlg(population, fitnessFunction, budget, functions, parameters, parallel, debug)
