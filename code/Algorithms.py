...
class _CustomizedES(object):
    ...
    def __init__(self, n, budget, mu=None, lambda_=None, opts=None, values=None):
        ...
        self.parameter_opts = {
            'n': n, 'budget': budget, 'mu': mu, 'lambda_': lambda_, 'u_bound': u_bound,
            'l_bound': l_bound,
        ...
        self.population = [FloatIndividual(n) for _ in range(mu_int)]
    ...
    def setBudget(self, budget):
        """
            ...
            :param budget:  Allowed evaluation budget for the optimization run
        """
        self.parameter_opts['budget'] = budget
    ...
    def runOptimizer(self, fitnessFunction):
        ...
        if self.opts['ipop']:
            results = localRestartAlgorithm(fitnessFunction, self.parameter_opts['budget'], functions, self.parameter_opts)
        else:
            parameters = Parameters(**self.parameter_opts)
            functions['mutateParameters'] = parameters.adaptCovarianceMatrix

            _, results = baseAlgorithm(self.population, fitnessFunction, self.parameter_opts['budget'], functions, parameters)
