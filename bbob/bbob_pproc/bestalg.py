...
from bbob.bbob_pproc import genericsettings, readalign, pproc
from bbob.bbob_pproc.toolsdivers import print_done
from bbob.bbob_pproc import toolsstats
    ...
    def pickle(self, outputdir=None, verbose=True):
        ...
        if getattr(self, 'modsFromPickleVersion', True):
            try:
                ...
                print( "I/O error: %s" % (errno, strerror) )
