...
from bbob.bbob_pproc import genericsettings
from bbob.bbob_pproc import dataoutput, pproc
from bbob.bbob_pproc.pproc import DataSetList, processInputArgs
from bbob.bbob_pproc.toolsdivers import prepend_to_file, strip_pathname2, str_to_latex
from bbob.bbob_pproc.compall import pprldmany, pptables, ppfigs
    ...
    * Generate post-processing data for some algorithms with figures in
    ...
    try:
        ...
        if inputsettings == "color":
            from bbob.bbob_pproc import config, genericsettings as inset # input settings
            config.config()
            ...
            from bbob.bbob_pproc import config, grayscalesettings as inset # input settings
            ...
            from bbob.bbob_pproc import config, bwsettings as inset # input settings
        else:
    ...
    if 1 < 3:
        ...
        # set target values
        from bbob.bbob_pproc import config
