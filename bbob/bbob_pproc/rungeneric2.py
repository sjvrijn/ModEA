...
import numpy
import numpy as np
from bbob.bbob_pproc import pproc
...
from bbob.bbob_pproc import genericsettings, config
from bbob.bbob_pproc import pprldistr
from bbob.bbob_pproc.pproc import DataSetList, processInputArgs, TargetValues, RunlengthBasedTargetValues
from bbob.bbob_pproc.toolsdivers import prepend_to_file, strip_pathname, str_to_latex
from bbob.bbob_pproc.comp2 import ppfig2, pprldistr2, pptable2, ppscatter
from bbob.bbob_pproc.compall import ppfigs
from bbob.bbob_pproc import ppconverrorbars
...
def main(argv=None):
    ...
    * From the python interpreter (requires that the path to this
    ...
    try:
        ...
        # from bbob.bbob_pproc import bbob2010 as inset # input settings
        if inputsettings == "color":
            from bbob.bbob_pproc import genericsettings as inset # input settings
            config.config()
        elif inputsettings == "grayscale": # probably very much obsolete
            from bbob.bbob_pproc import grayscalesettings as inset # input settings
        elif inputsettings == "black-white": # probably very much obsolete
            from bbob.bbob_pproc import bwsettings as inset # input settings
        else:
