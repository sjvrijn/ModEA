...
from bbob.bbob_pproc.pptex import tableLaTeX, tableLaTeXStar, writeFEvals2, writeFEvalsMaxPrec, writeLabels
from bbob.bbob_pproc.toolsstats import significancetest
