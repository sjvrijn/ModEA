...
from bbob.bbob_pproc import genericsettings, toolsstats, bestalg, pproc
from bbob.bbob_pproc.ppfig import saveFigure, groupByRange
...
def beautify(axesLabel=True):
    ...
    for i in range(-2, 7, 1 if ymax <= 1e3 else 2):
