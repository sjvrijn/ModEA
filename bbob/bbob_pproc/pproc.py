...
from bbob.bbob_pproc import genericsettings, findfiles, toolsstats, toolsdivers
from bbob.bbob_pproc import genericsettings as gs
from bbob.bbob_pproc.readalign import split, alignData, HMultiReader, VMultiReader
from bbob.bbob_pproc.readalign import HArrayMultiReader, VArrayMultiReader, alignArrayData
from bbob.bbob_pproc.ppfig import consecutiveNumbers
    ...
    def initialize(self):
        ...
        if self.reference_data in self.known_names: # bestalg data are loaded
            ...
            if self.reference_data == 'bestGECCO2009':
                from bbob.bbob_pproc import bestalg
            ...
            if not isinstance(self.reference_data[0], str):
...
class DataSetList(list):
    ...
    def __init__(self, args=[], verbose=False, check_data_type=True):
        ...
        fnames = []
        for name in args:
            if isinstance(name, str) and findfiles.is_recognized_repository_filetype(name):
